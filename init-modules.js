/**
 * Script pour initialiser la table des modules et les relations
 * Ce script lit les fichiers SQL et les exécute dans la base de données
 */
...
async function initModules() {
  ...
  try {
    ...
    const sqlFilePath = path.join(__dirname, 'sql', 'init_modules.sql');
